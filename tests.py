...
import unittest
import sys
from utils import read_yaml, load_regions, get_countries_for_sector
...
class TestCoverage(unittest.TestCase):
    ...
    def check_world_coverage(self, portfolio):
        ...
        if all_same and first_value == expected_coverage:
            ...
            return False, f"Incomplete coverage: all countries have {first_value}, but {', '.join(details)}"
        else:
            inconsistent = {country: coverage for country, coverage in cap_coverage.items() 
    ...
    def test_ssac_portfolio_incomplete(self):
        ...
        is_perfect, details = self.check_world_coverage(portfolio)
        self.assertFalse(is_perfect, "SSAC portfolio should not have perfect coverage (missing Small caps)")
...
class TestRegions(unittest.TestCase):
    ...
    def test_developed_and_emerging_cover_all(self):
        ...
        self.assertEqual(set(self.all_countries), all_from_markets,
    ...
    def test_developed_europe_subset_of_developed(self):
        ...
        self.assertTrue(developed_europe.issubset(developed),
                       "Developed Europe should be subset of Developed")
    ...
    def test_pacific_ex_japan_subset_of_developed(self):
        ...
        self.assertTrue(pacific_ex_japan.issubset(developed),
                       "Pacific ex Japan should be subset of Developed")
...
class TestUtilities(unittest.TestCase):
    ...
    def test_get_countries_for_region(self):
        ...
        countries = get_countries_for_sector('Developed Europe', self.region_groupings, self.all_countries)
    ...
    def test_get_countries_for_individual_country(self):
        ...
        countries = get_countries_for_sector('United States', self.region_groupings, self.all_countries)
    ...
    def test_get_countries_for_invalid_sector(self):
        ...
        countries = get_countries_for_sector('Invalid Sector', self.region_groupings, self.all_countries)
